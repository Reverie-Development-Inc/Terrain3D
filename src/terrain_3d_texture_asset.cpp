...
void Terrain3DTextureAsset::_bind_methods() {
	...
	// Bound as *_asset_name: Godot 4.8 refuses a bind whose name exists on an ancestor
	// (Resource.set_name/get_name), so the ClassDB names differ from the C++ overrides.
